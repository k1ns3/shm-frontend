        ...
        <ul>
          <li>
            ...
            <p className="doship-block__title-small">
              наличие 100% шипов - это надежное сцепление с дорожным покрытием в
          ...
          <li>
            Экономичность
            <p className="doship-block__title-small">
              нет необходимости покупать новый комплект шин из-за потери при ещё
              "рабочем" протекторе
            </p>
          </li>
          ...
          <p className="doship-block__text">
            ​Главное отличие — это форма ремонтного шипа, которая позволяет ему
            прочно удерживаться в старых и разбитых отверстиях. Уникальная форма
            шипа (патент № 98355), разработанная специалистами компании «Теком»,
            гарантирует ему надежную фиксацию в резине протектора. Новая
            технология позволяет ошиповать б/у колеса, сохраняя необходимые
            характеристики и продлевая срок их службы! Это подтверждено тестами,
            проведенными на базе испытательной лаборатории «Теком» и на дорогах
            Северо-Запада. Тесты показали, что сила удержания ремонтного шипа в
            резине протектора такая же как и при заводской ошиповке. Длина
            тормозного пути по сравнению с оригинальными шипами остается
            неизменной.
          </p>
          ...
          <p className="doship-block__text">
            ...
            <div className="doship-block__text-items">
              Автошина должна быть изначально ошипована заводом-изготовителем.
            </div>
            <div className="doship-block__text-items">
