...
function WheelStudding() {
  return (
    <div class="cart">
      <div class="container">
        <div class="doship">
          <div class="doship-block">
            <div class="doship-block__row">
              <img src={wheelQuatro} class="doship-block__img" />
              <ul>
                <li>
            ...
            <span class="doship-block__title">Преимущества</span>
            <ul>
              <li>
                Безопасность
                <p class="doship-block__title-small">
              ...
              <p class="doship-block__text">Стоимость ошиповки 15 руб./1шип</p>
              <p class="doship-block__text">
                <div class="doship-block__text-items">
